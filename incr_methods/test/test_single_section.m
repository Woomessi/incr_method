...
v = [surface_section(i,[1:3]); surface_section(i,[4:6]); surface_section(i,[7:9])];
V = [V;v];
F = [F;F_0];
F_0 = F_0+3;
end
col = surface_section(:,23);
...
% -23.7088623046875	-41.2894897460938	4.90612792968750
% -17.0238037109375	-42.8468322753906	4.27084350585938
% -16.9641113281250	-42.8433532714844	4.27293395996094