...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 1:size_points_path
    points_mat(i,:) = cell2mat(all_points_path{4,i});
end
for j = 1:6
points_moving_average(:,j) = movmean(points_mat(:,j),3);
end
scatter3(points_mat(:,1),points_mat(:,2),points_mat(:,3),10,'magenta','filled')
hold on
quiver3(points_mat(:,1),points_mat(:,2),points_mat(:,3),points_mat(:,4),points_mat(:,5),points_mat(:,6),'r')
hold on
scatter3(points_moving_average(:,1),points_moving_average(:,2),points_moving_average(:,3),10,'blue','filled')
hold on
quiver3(points_moving_average(:,1),points_moving_average(:,2),points_moving_average(:,3),points_moving_average(:,4),points_moving_average(:,5),points_moving_average(:,6),'r')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
