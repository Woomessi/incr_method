...
while y_ori-D >= min_y-d
        while x_ori+D <= max_x+10
            ...
            [point_surface_section,normal_surface_section] = offsetting_1(5,point_surface_section,normal_surface_section);
...
%         c = 1;
        for c = 1:size(all_surface_section{i,b},1)
            ...
            for d = 2:size_points_path
                ...
                q_1 = M(i,d-1).*CDB(q_0,h,l,cos_gamma,cos_theta)./v;
...
hold on
quiver3(triangles(:,19),triangles(:,20),triangles(:,21),triangles(:,10),triangles(:,11),triangles(:,12),'y')
% hold on
scatter3(cell2mat(all_surface_section{1,1}(c,[1,4,7]))',cell2mat(all_surface_section{1,1}(c,[2,5,8]))',cell2mat(all_surface_section{1,1}(c,[3,6,9]))',100,'red','filled')
% cell2mat(all_surface_section{1,1}(c,[1,4,7]))'